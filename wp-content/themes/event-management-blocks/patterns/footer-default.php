...
return array(
    ...
    'content'    => '<!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|fourground"}}}},"backgroundColor":"tertiary","textColor":"background","layout":{"type":"constrained","contentSize":"80%"}} -->
    <div class="wp-block-group has-background-color has-tertiary-background-color has-text-color has-background has-link-color"><!-- wp:columns {"className":"alignwide","style":{"spacing":{"padding":{"top":"35px","bottom":"35px","right":"0px","left":"0px"},"blockGap":{"top":"0","left":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
        ...
        <!-- wp:group {"className":"copyright-text","backgroundColor":"tertiary","layout":{"type":"constrained","contentSize":"80%"}} -->
        <div class="wp-block-group copyright-text has-tertiary-background-color has-background"><!-- wp:columns -->
