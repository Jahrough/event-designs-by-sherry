...
class Arabic
{
    ...
    public function __construct() {
        ...
        $this->arFemaleNames = file($this->rootDirectory . '/data/ar_female.txt', FILE_IGNORE_NEW_LINES); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
    ...
    public function date( $format, $timestamp, $correction = 0 ) {
        if ( $this->arDateMode == 1 || $this->arDateMode == 8 ) {
            ...
            */
            ...
            list($y, $m, $d) = explode(' ', gmdate('Y m d', $timestamp));
