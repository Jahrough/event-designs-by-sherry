...
throw new Exception( sprintf( "The row #%d could not be found, please file an issue in the tracker with the HTML code", esc_html( $i ) ) );
            }
    ...
    public function __toString() {
        ...
        if ( php_sapi_name() == "cli" ) {
            $str = wp_strip_all_tags(str_replace([ "<br/>", "<b>", "</b>" ],
