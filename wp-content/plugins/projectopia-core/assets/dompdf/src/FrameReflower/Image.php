    ...
    function get_min_max_width() {
        ...
        if ( $this->get_dompdf()->getOptions()->getDebugPng() ) {
			...
			print "get_min_max_width() " .
				esc_html( $frame->get_style()->width ) . ' ' .
				esc_html( $frame->get_style()->height ) . ';' .
				esc_html( $frame->get_parent()->get_style()->width ) . " " .
				esc_html( $frame->get_parent()->get_style()->height ) . ";" .
				esc_html( $frame->get_parent()->get_parent()->get_style()->width ) . ' ' .
				esc_html( $frame->get_parent()->get_parent()->get_style()->height ) . ';' .
				esc_html( $img_width ) . ' ' .
				esc_html( $img_height ) . '|';
