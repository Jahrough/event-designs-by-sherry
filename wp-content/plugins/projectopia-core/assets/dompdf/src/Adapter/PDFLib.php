...
class PDFLib implements Canvas
{
    ...
    public function stream( $filename = "document.pdf", $options = [] ) {
        ...
        if ( self::$IN_MEMORY ) {
            ...
            if ( ! $fh ) {
				throw new Exception("Unable to load temporary PDF file: " . esc_html($this->_file));
            }
            ...
            if ( $this->_dompdf->getOptions()->getDebugPng() ) {
				print '[pdflib stream unlink ' . esc_url($this->_file) . ']';
            }
    ...
    public function output( $options = [] ) {
        ...
        if ( self::$IN_MEMORY ) {
            ...
            //debugpng
            if ( $this->_dompdf->getOptions()->getDebugPng() ) {
				print '[pdflib output unlink ' . esc_url($this->_file) . ']';
