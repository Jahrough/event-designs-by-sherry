...
class DeclarationBlock extends RuleSet {
	...
	public static function parse(ParserState $oParserState) {
		$aComments = array();
		$oResult = new DeclarationBlock(esc_html($oParserState->currentLine()));
	...
	public function render(\Sabberworm\CSS\OutputFormat $oOutputFormat) {
		if(count($this->aSelectors) === 0) {
			...
			throw new OutputException( esc_html( "Attempt to print declaration block with missing selector" ), esc_html($this->iLineNo ));
		}
