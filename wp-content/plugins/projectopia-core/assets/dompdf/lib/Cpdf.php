        ...
        switch ( $action ) {
            ...
            case 'byterange':
                ...
                if ( strlen($signature) > $sign_maxlen ) {
                    throw new \Exception( esc_html( "Signature length ($siglen) exceeds the $sign_maxlen limit." ) );
                }
    ...
    function addImagePng( &$img, $file, $x, $y, $w = 0.0, $h = 0.0, $is_mask = false, $mask = null ) {
        ...
        if ( isset($this->imagelist[ $file ]) ) {
            ...
            if ( defined("DEBUGPNG") && DEBUGPNG ) {
                print '[addImagePng ' . esc_html($file) . ']';
            }
            ...
            if ( $error ) {
                $this->addMessage('PNG error - (' . esc_html($file) . ') ' . $errormsg);
        ...
        if ( isset($this->imagelist[ $file ]) ) {
            ...
            if ( ! $error ) {
                ...
                if ( mb_substr($data, 0, 8, '8bit') != $header ) {
                    ...
                    if ( defined("DEBUGPNG") && DEBUGPNG ) {
                        print '[addPngFromFile this file does not have a valid header ' . esc_html($file) . ']';
                    }
            ...
            if ( ! $error ) {
                    ...
                    switch ( $chunkType ) {
                        case 'IHDR':
                            ...
                            if ( $info['compressionMethod'] != 0 ) {
                                ...
                                //debugpng
                                if ( defined("DEBUGPNG") && DEBUGPNG ) {
                                    print '[addPngFromFile unsupported compression method ' . esc_html($file) . ']';
                                }
                            ...
                            if ( $info['filterMethod'] != 0 ) {
                                ...
                                //debugpng
                                if ( defined("DEBUGPNG") && DEBUGPNG ) {
                                    print '[addPngFromFile unsupported filter method ' . esc_html($file) . ']';
                                }
                        ...
                        case 'tRNS':
                            ...
                            switch ( $info['colorType'] ) {
                                ...
                                default:
                                    if ( defined("DEBUGPNG") && DEBUGPNG ) {
                                        print '[addPngFromFile unsupported transparency type ' . esc_html($file) . ']';
                                    }
                                    break;
                            }
                ...
                if ( ! $haveHeader ) {
                    ...
                    //debugpng
                    if ( defined("DEBUGPNG") && DEBUGPNG ) {
                        print '[addPngFromFile information header is missing ' . esc_html($file) . ']';
                    }
                ...
                if ( isset($info['interlaceMethod']) && $info['interlaceMethod'] ) {
                    ...
                    //debugpng
                    if ( defined("DEBUGPNG") && DEBUGPNG ) {
                        print '[addPngFromFile no support for interlaced images in pdf ' . esc_html($file) . ']';
                    }
            ...
            if ( ! $error && $info['bitDepth'] > 8 ) {
                ...
                //debugpng
                if ( defined("DEBUGPNG") && DEBUGPNG ) {
                    print '[addPngFromFile bit depth of 8 or less is supported ' . esc_html($file) . ']';
                }
            ...
            if ( ! $error ) {
                switch ( $info['colorType'] ) {
                    ...
                    default:
                        ...
                        //debugpng
                        if ( defined("DEBUGPNG") && DEBUGPNG ) {
                            print '[addPngFromFile alpha channel not supported: ' . esc_html($info['colorType']) . ' ' . esc_html($file) . ']';
                        }
