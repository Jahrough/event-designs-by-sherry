...
add_action( 'admin_menu' , 'register_pto_updates_page', 29 ); 
function register_pto_updates_page() {

	$my_page = add_submenu_page(    
		'pto-updates',
		__('Project Updates', 'projectopia-core'),             
		'<span class="pto-sm-hidden">' . esc_html__('Project Updates', 'projectopia-core') . '</span>',             
		'cqpim_view_dashboard',             
		'pto-updates',      
		'pto_updates'
	);
...
function pto_updates() {
	...
	<div class="dashboardWrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card all-project-card projectActivities ">
						<div class="card-header d-block d-md-flex ">
							<div class="card-header-info d-flex align-items-center">
								<img src="<?php echo esc_url( PTO_PLUGIN_URL ) .'/assets/admin/img/taskIcon.png'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="" class="img-fluid mr-2" />
						...
						<div class="card-body dailyUpdate">
							...
							<div class="dailyUpdateInner" style="padding: 1.5625rem 1.875rem;">
