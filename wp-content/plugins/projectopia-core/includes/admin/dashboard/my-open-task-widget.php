        ...
        <div class="cardNavTabWrapper d-block d-sm-flex">
            ...
            <div class="searchWrapper mt-3 mt-sm-0">
                <button class="searchBtn">
                    <img src="<?php echo esc_url( PTO_PLUGIN_URL ) .'/assets/admin/img/searchicon.png'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid mr-2" />
                </button>
