...
<div id="overlay" style="display:none">
	<div id="spinner">
		<img src="<?php echo esc_url( PTO_PLUGIN_URL ) . '/img/loading_spinner.gif'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
	</div>
</div>
			...
			<div id="cqpim_admin_head_inside">
				<ul>
					<li class="nodesktop cd-menu">
						<a class="menu-open" title="<?php esc_html_e('Menu', 'projectopia-core'); ?>" href="#"><img src="<?php echo esc_url( PTO_PLUGIN_URL ) . '/img/menu.png'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="Menu" /></a>
						<a style="display:none" class="menu-close" title="<?php esc_html_e('Close Menu', 'projectopia-core'); ?>" href="#"><img src="<?php echo esc_url( PTO_PLUGIN_URL ) . '/img/close.png'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="Menu" /></a>
					</li>
					<?php
					$logo = get_option('cqpim_dash_logo'); 
					if ( $logo ) { ?>
						<li style="width:190px; padding-right:15px; text-align:center; overflow:hidden; max-height:54px">
							<img style="max-width:100%" src="<?php echo esc_url($logo['cqpim_dash_logo']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />			
						</li>
					<?php } ?>
				...
				<ul id="cd-head-actions">
					...
					<li class="desktop_items">
						<span class="cqpim_icon">
						<a href="<?php echo esc_url(add_query_arg('pto-page', 'client-files', get_the_permalink($client_dash))); ?>"><i class="fa fa-file cqpim_tooltip" aria-hidden="true" title="<?php esc_html_e('Client Files', 'projectopia-core'); ?>"></i></a>						</span>
					</li>
