				...
				<tr>
					<td style="margin:0; padding:0;">
						<?php if ( ! empty($inv_logo['cqpim_invoice_logo']) ) { ?>
							<img src="<?php echo isset($inv_logo['cqpim_invoice_logo']) ? esc_url( $inv_logo['cqpim_invoice_logo'] ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" style="max-height: 60px;" />
						<?php } else { ?>
							<img src="<?php echo isset($logo['company_logo']) ? esc_url( $logo['company_logo'] ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" style="max-height: 60px;" />
						<?php } ?>
					</td>
			...
			<table style="width:100%; border: 1px solid #fff; border-collapse:collapse;text-align:center;" id="invoice_items">
				...
				<?php } ?>
					...
					<tr>
                        ...
                        <?php $outstanding = (float)$outstanding - (float)$received; ?>
