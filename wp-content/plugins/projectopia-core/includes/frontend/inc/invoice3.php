				...
				<tr>
					<td style="padding:15px 15px 15px 0;">
						<?php if ( ! empty($inv_logo['cqpim_invoice_logo']) ) { ?>
							<img src="<?php echo isset($inv_logo['cqpim_invoice_logo']) ? esc_url( $inv_logo['cqpim_invoice_logo'] ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" style="max-height: 130px;" />
						<?php } else { ?>
							<img src="<?php echo isset($logo['company_logo']) ? esc_url( $logo['company_logo'] ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" style="max-height: 130px;" />
						<?php } ?>
					</td>
