...
$client_logs[ $now ] = array(
	'user' => $user->ID,
	'page' => __('Client Dashboard Projects Page', 'projectopia-core'),
);
...
<div class="cqpim_block_title">
	<div class="caption">
		...
		<span class="caption-subject font-light-violet sbold"><?php esc_html_e('Projects', 'projectopia-core'); ?></span>
	</div>
</div>
<br />
<table class="datatable_style dataTable" id="front_projectpage_table" data-ordering="[[ 4, 'asc' ]]", data-state-save="true">
	<thead>
		<tr>
	...
	<tbody>
		...
		foreach ( $projects as $project ) { 
			...
			$current_date = time();
            // days_to_due should be 0 when project status is signoff or closed
			if ( $signoff || $closed ) {
				$days_to_due = 0;
			}else {
