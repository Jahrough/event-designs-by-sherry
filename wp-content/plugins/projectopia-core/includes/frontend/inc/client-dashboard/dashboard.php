		...
		<table class="cqpim_table dash">
			...
			<tbody>
				...
				foreach ( $projects as $project ) { 
					...
					$contract = add_query_arg('pto-page', 'contract', $url);
		...
		<table class="cqpim_table dash">
			...
			<tbody>
				...
				foreach ( $quotes as $quote ) { 
					...
					$quote_link = '<a class="cqpim-link" href="' . esc_url(add_query_arg('pto-page', 'quote', $url)) . '">' . $quote->post_title . '</a>';
	...
	<?php if ( empty($stickets) && pto_has_addon_active_license( 'pto_st', 'tickets' ) ) { ?>
		<div class="cqpim-dash-item-triple grid-item">
			...
			<div class="cqpim_block_title">
				...
				<div class="actions">
					<a class="cqpim_button cqpim_small_button border-green-sharp font-light-violet rounded_2 sbold" href="<?php echo esc_url(add_query_arg('pto-page', 'add-support-ticket', get_the_permalink($client_dash))); ?>"><?php esc_html_e('Add Support Ticket', 'projectopia-core'); ?></a>
				</div>
			</div>
			<br />
				<?php 
