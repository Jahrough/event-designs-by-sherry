		...
		foreach ( $quotes as $quote ) { 
			...
			?>						
				<tr>	
					...
					<td><span class="nodesktop"><strong><?php esc_html_e('Title', 'projectopia-core'); ?></strong>: </span> <a class="cqpim-link" href="<?php echo esc_url(add_query_arg('pto-page', 'quote', $url)); ?>"><?php echo esc_html( $quote->post_title ); ?></a></td>
