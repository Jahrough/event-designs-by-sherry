<div id="cqpim-dash-content">
	<div id="cqpim_admin_title">
		...
		echo '<a href="' . esc_url(get_the_permalink($client_dash)) . '">' . esc_html__('Dashboard', 'projectopia-core') . '</a> <i class="fa fa-circle"></i> <a href="' . esc_url(add_query_arg('pto-page', 'quotes', get_the_permalink($client_dash))) . '">' . esc_html__('Quotes / Estimates', 'projectopia-core') . '</a> <i class="fa fa-circle"></i> ' . esc_html($p_title); ?>
	</div>
			...
			<div class="cqpim-dash-item-full grid-item">
				<div class="cqpim_block quote_layout">
					<div class="cqpim_block_title">
						...
						<div class="actions">
							<a class="cqpim_button cqpim_small_button border-green-sharp font-light-violet rounded_2 sbold" href="<?php echo esc_url(add_query_arg('pto-page', 'print', get_the_permalink())); ?>" target="_blank"><?php esc_html_e('VIEW PRINTABLE VERSION', 'projectopia-core'); ?></a>
						</div>
					</div>
