...
<div class="cqpim-dash-content">
	...
	<div id="cqpim-dash-content">
		<div id="cqpim_admin_title">
			<?php 
				echo '<a href="' . esc_url(get_the_permalink($client_dash)) . '">' . esc_html__('Dashboard', 'projectopia-core') . '</a> <i class="fa fa-circle"></i> <a href="' . esc_url(add_query_arg('pto-page', 'faq', get_the_permalink($client_dash))) . '">' . esc_html__('FAQ', 'projectopia-core') . '</a> <i class="fa fa-circle"></i> ' . esc_html($post->post_title); 
			?>
		</div>
