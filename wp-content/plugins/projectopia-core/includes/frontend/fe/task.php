	...
	<div class="masonry-grid">
		...
		<div class="cqpim-dash-item-double grid-item">
			<div class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Task Details', 'projectopia-core'); ?> </span>
					</div>
				</div>
				<?php
		...
		<div class="cqpim-dash-item-triple grid-item">
			<div class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Task Messages', 'projectopia-core'); ?></span>
					</div>
				</div>
				<?php
				...
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Update Task', 'projectopia-core'); ?></span>
					</div>
				</div>				
				<?php
				...
				if ( ! empty($fields) ) {
					...
					foreach ( $fields as $field ) {
						...
						if ( $field->type == 'header' ) {
							...
							echo '<textarea class="cqpim-custom ' . esc_attr( $p_class_name ) . '" id="' . esc_attr( $n_id ) . '" ' . esc_attr( $required ) . ' name="' . esc_attr( $field->name ) . '">' . esc_attr( $value ) . '</textarea>';
				...
				<a href="#" id="update_task" class="cqpim_button font-white bg-blue mt-20 right op rounded_2"><?php esc_html_e('Update Task', 'projectopia-core'); ?></a>
				<div class="clear"></div>							
			</div>
		</div>
		...
		if ( empty($hide_time) ) { ?>
			<div class="cqpim-dash-item-double grid-item">
				<div class="cqpim_block">
					<div class="cqpim_block_title">
						<div class="caption">
							<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Time Entries', 'projectopia-core'); ?></span>
						</div>
					</div>
					<?php
		...
		<div class="cqpim-dash-item-double grid-item">
			<div class="cqpim_block">
				<div class="cqpim_block_title">
					<div class="caption">
						<span class="caption-subject font-green-sharp sbold"><?php esc_html_e('Task Files', 'projectopia-core'); ?></span>
					</div>
				</div>
