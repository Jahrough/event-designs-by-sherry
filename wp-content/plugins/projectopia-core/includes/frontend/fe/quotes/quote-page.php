	<?php
	// If page is quote then show messaging page in wp-theme.
		...
		<div class="cqpim_block quote_layout">
			<div class="cqpim_block_title">
				...
				<div class="actions">
					...
					?>
					<a class="cqpim_button cqpim_small_button border-green-sharp font-green-sharp rounded_2 sbold" href="<?php echo esc_url($print_url); ?>" target="_blank"><?php esc_html_e('VIEW PRINTABLE VERSION', 'projectopia-core'); ?></a>
				</div>
			</div>
