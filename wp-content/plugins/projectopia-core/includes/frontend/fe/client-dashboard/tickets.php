...
<div class="cqpim_block">
	<div class="cqpim_block_title">
		...
		<div class="actions">
			<?php 
            	$add_ticket_url = add_query_arg('pto-page', 'add-support-ticket', get_the_permalink($client_dash));
            ?>
            <a href="<?php echo esc_url($add_ticket_url); ?>" class="cqpim_button cqpim_small_button font-green-sharp border-green-sharp op"><?php esc_html_e('Add Support Ticket', 'projectopia-core'); ?></a>
		</div>
	</div>
	<?php 
