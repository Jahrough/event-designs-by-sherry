	...
	<div class="cqpim-dash-item-inside">
		...
		if ( ! empty($messages) ) {
			$alerts[] = array(
				'type'  => 'message',
				'level' => 'info',
				'data'  => __('You have new messages', 'projectopia-core') . ' - <a style="color:#222" href="' . esc_url(add_query_arg('pto-page', 'messages', get_permalink())) . '">' . esc_html__('View', 'projectopia-core') . '</a>',
			);                  
		}
