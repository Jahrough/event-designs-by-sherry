					...
					<tbody>
						<?php foreach ( $conversations as $conversation ) { 
							...
							<tr <?php if ( empty($read_val) ) { echo ' class="cqpim-unread"'; } ?>>
								<td>
									<?php if ( empty($read_val) ) { echo '<i class="fa fa-envelope" aria-hidden="true"></i> '; } else { echo '<i class="fa fa-envelope-open" aria-hidden="true"></i> '; } ?>&nbsp;&nbsp;
									<?php 
										$message_url = add_query_arg(
											...
											get_the_permalink($client_dash)
										);
									?>
									<a href="<?php echo esc_url($message_url); ?>">
										<?php echo esc_html(str_replace('Private: ', '', get_the_title($conversation->ID))); ?>
									</a>
								</td>
