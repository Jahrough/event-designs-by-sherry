									...
									<?php if ( ! empty( $element['cost'] ) ) { ?>
										<div class="mileStone-content-singleDeadline d-flex">
											<div class="mileStone-content-icon">
												<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/usacoin.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="icon img-fluid mr-2" />
											</div>
