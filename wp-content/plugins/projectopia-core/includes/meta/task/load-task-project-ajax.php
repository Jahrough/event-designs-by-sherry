...
<div <?php if ( ! empty($hide) ) { ?>style="display:none"<?php } ?> class="dd-task" id="task-<?php echo esc_attr( $task_pid ); ?>">
	...
	<?php } ?>
	<div class="dd-task-status mt-2" id="task-<?php echo esc_attr( $task_pid ); ?>-status">
		...
		<div class="mileStone-addSchedule">
			<div class="d-flex flex-wrap">
				<div class="addSchedule">
					...
					<input
						type="text"
						id="start_<?php echo esc_attr( $task_pid ); ?>"
						data-id="<?php echo esc_attr( $task_pid ); ?>"
				...
				<div class="addSchedule">
					...
					<input type="text"
						id="end_<?php echo esc_attr( $task_pid ); ?>" 
						data-id="<?php echo esc_attr( $task_pid )?>"
				...
				<div class="addSchedule">
					...
					<select data-id="<?php echo esc_attr( $task_pid ); ?>"
