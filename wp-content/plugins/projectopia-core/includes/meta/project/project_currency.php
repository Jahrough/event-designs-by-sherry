...
function pto_project_currency_metabox_callback( $post ) {
	...
	<div class="cqpim-alert cqpim-alert-info alert-display">
		<h5>
			<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/usacoin.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" 
