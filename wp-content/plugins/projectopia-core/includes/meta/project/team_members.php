					...
					<div class="member-grid text-center mx-3">
						...
						<div class="dropdown ideal-littleBit-action ideal-littleBit-action  dropdown-edit dropBottomRight">
							<button class="btn px-3" type="button"
								...
								aria-expanded="false">
								<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/verticale-helip.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt=""
									class="img-fluid" />
							</button>
							<div class="dropdown-menu">
								...
								if ( current_user_can( 'edit_cqpim_teams' ) ) {
									...
									<a href="<?php echo esc_url( $team_url ); ?>" class="dropdown-item" type="button">
										<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/edit.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt=""
											class="img-fluid" />
								...
								if ( current_user_can( 'cqpim_edit_project_members' ) ) { ?>
									<button class="dropdown-item delete_team" type="button" data-team="<?php echo esc_attr( $contributor['team_id'] ); ?>" value="<?php echo esc_attr( $key ); ?>">
										<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/delete.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="" class="img-fluid" />
