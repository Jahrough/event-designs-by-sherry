...
function pto_project_details_metabox_callback( $post ) {
	...
	$contract_link = add_query_arg('pto-page', 'contract-print', get_the_permalink($post->ID));
	$summary_link = add_query_arg(
		array(
			'page' => 'summary',
			'sub' => 'updates'
		),
	...
	if ( ! empty($quote_ref) ) { 
		...
		<div class="pto-project-information mt-2">
			...
			<div class="d-flex mb-2">
				<figure class="mr-2">
					<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/fakeicon.png' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
				</figure>
				<div class="content">
			...
			if ( $start_date ) {
				...
				<div class="d-flex mb-2">
					<figure class="mr-2">
						<img class="bg-blue-sharp full-rounded" src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/clander.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
					</figure>
					<div class="content">
					...
					<div class="team_details">
						...
						<?php if ( ! empty( $team_telephone ) ) { ?>
							<p class="pb-1">
								<a href="tel:<?php echo esc_attr( $team_telephone ); ?>">
									<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/phone-fill.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="icon img-fluid mr-2" />
						...
						<p class="pb-1">
							<a href="mailto:<?php echo esc_attr( $team_email ); ?>">
								<img src="<?php echo esc_url( PTO_PLUGIN_URL .'/assets/admin/img/mail-fill.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="icon img-fluid mr-2" />
	...
	if ( ! empty($client_id) && current_user_can('cqpim_view_project_client_info') ) { ?>
		<div class="pto-project-client-details mt-4">
			...
			<div class="d-flex mb-2">
				<figure class="mr-2">
					<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/mail-fill.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
				</figure>
				<div class="content">
			...
			<div class="d-flex mb-2">
				<figure class="mr-2">
					<img src="<?php echo esc_url( PTO_PLUGIN_URL .'/assets/admin/img/phone-fill.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
				</figure>
				<div class="content">
