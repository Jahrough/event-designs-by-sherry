				...
				<div class="dd-milestone-info mileStone-content-taskBar d-block flex-wrap d-md-flex justify-content-between align-items-center">
					<div class="mileStone-content-deadline d-block d-sm-flex">
							...
							if ( current_user_can( 'cqpim_view_project_financials' ) && ! empty( $element_to_add['cost'] ) ) { ?>
								<div class="mileStone-content-singleDeadline d-flex">
									<div class="mileStone-content-icon">
										<img src="<?php echo esc_attr( PTO_PLUGIN_URL . '/assets/admin/img/usacoin.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="icon img-fluid mr-2" />
									</div>
						...
						<?php if ( ! empty($element_to_add['start']) ) { ?>
							<div class="mileStone-content-singleDeadline d-flex">
								<div class="mileStone-content-icon">
									<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/clander.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="icon img-fluid mr-2" />
								</div>
								<div class="mileStone-content-info">
