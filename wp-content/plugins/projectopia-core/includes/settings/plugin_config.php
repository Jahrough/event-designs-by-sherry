...
function register_pto_settings() {
	...
	register_setting( 'cqpim_settings', 'cqpim_use_default_icon', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_show_docs_link', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_online_widget', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_date_format', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_allowed_extensions', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_timezone', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_disable_avatars', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_invoice_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_quote_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_project_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_support_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_task_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_bug_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_subs_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'cqpim_faq_slug', 'sanitize_title' );
	register_setting( 'cqpim_settings', 'enable_quotes', 'absint' );
	register_setting( 'cqpim_settings', 'disable_tickets', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_enable_messaging', 'absint' );
	register_setting( 'cqpim_settings', 'enable_quote_terms', 'absint' );
	register_setting( 'cqpim_settings', 'enable_project_creation', 'absint' );
	register_setting( 'cqpim_settings', 'enable_project_contracts', 'absint' );
	register_setting( 'cqpim_settings', 'disable_invoices', 'absint' );
	register_setting( 'cqpim_settings', 'invoice_workflow', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'auto_send_invoices', 'absint' );

	// Company Settings
	register_setting( 'cqpim_settings', 'team_type', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'company_name', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'company_address', 'sanitize_textarea_field' );
	...
	register_setting( 'cqpim_settings', 'company_logo', 'pto_validate_image' ); // Custom function
	...
	register_setting( 'cqpim_settings', 'currency_symbol_position', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'currency_symbol_space', 'absint' );
	register_setting( 'cqpim_settings', 'currency_decimal', 'absint' );
	register_setting( 'cqpim_settings', 'currency_comma', 'sanitize_text_field' );
	...
	register_setting( 'cqpim_settings', 'currency_code', 'sanitize_text_field' );
	...
	register_setting( 'cqpim_settings', 'company_invoice_terms', 'wp_kses_post' );
	...
	// Admin dashboard.
	register_setting( 'cqpim_settings', 'cqpim_admin_dash_css', 'wp_strip_all_tags' );
	register_setting( 'cqpim_settings', 'cqpim_save_dashboard_metabox_filters', 'absint' );

	// Business Hours
	register_setting( 'cqpim_settings', 'pto_opening' ); //allow saving arrays 
	register_setting( 'cqpim_settings', 'pto_support_open_message', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_support_closed_message', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_support_opening_warning', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_shortcode_open_message', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_shortcode_closed_message', 'wp_kses_post' );

	// Lead Settings
	register_setting( 'cqpim_settings', 'new_lead_email_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'new_lead_email_content', 'wp_kses_post' );

	// Client Settings
	register_setting( 'cqpim_settings', 'client_dashboard_type', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_dashboard_gfont', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_dashboard_primary_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_dashboard_secondary_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_dashboard_link_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_dashboard_link_hover_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_dashboard_button_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_dashboard_text_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_login_bg_color', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'cqpim_login_reg', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_login_reg_company', 'absint' );
	register_setting( 'cqpim_settings', 'pto_dcreg_approve', 'absint' );
	register_setting( 'cqpim_settings', 'auto_welcome', 'absint' );
	register_setting( 'cqpim_settings', 'auto_welcome_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'auto_welcome_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_password_reset_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_password_reset_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'password_reset_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'password_reset_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'added_contact_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'added_contact_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'allow_client_settings', 'absint' );
	register_setting( 'cqpim_settings', 'allow_client_users', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_dash_logo', 'pto_validate_logo' ); // Custom function
	register_setting( 'cqpim_settings', 'cqpim_dash_bg', 'pto_validate_bg' ); // Custom function

	// Quote Settings
	register_setting( 'cqpim_settings', 'enable_frontend_anon_quotes', 'absint' );
	register_setting( 'cqpim_settings', 'enable_client_quotes', 'absint' );
	register_setting( 'cqpim_settings', 'quote_header', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'quote_footer', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'quote_acceptance_text', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'quote_email_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'quote_email_pdf_attach', 'absint' );
	register_setting( 'cqpim_settings', 'quote_default_email', 'sanitize_email' );
	register_setting( 'cqpim_settings', 'client_quote_message_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_quote_message_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'company_quote_message_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'company_quote_message_email', 'wp_kses_post' );

	// Project Settings
	register_setting( 'cqpim_settings', 'pto_default_project_sort', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'pto_default_project_order', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'pto_default_drop_closed', 'absint' );
	register_setting( 'cqpim_settings', 'default_contract_text', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'contract_acceptance_text', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_contract_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_contract_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_update_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_update_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_message_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_message_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'company_message_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'company_message_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'auto_contract', 'absint' );
	register_setting( 'cqpim_settings', 'auto_invoice', 'absint' );
	register_setting( 'cqpim_settings', 'auto_update', 'absint' );
	register_setting( 'cqpim_settings', 'auto_completion', 'absint' );

	// Invoice Settings
	register_setting( 'cqpim_settings', 'cqpim_invoice_template', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_invoice_prefix', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_invoice_logo', 'pto_validate_invlogo' ); // Custom function
	register_setting( 'cqpim_settings', 'cqpim_clean_main_colour', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'cqpim_cool_main_colour', 'sanitize_hex_color' );
	register_setting( 'cqpim_settings', 'client_invoice_email_attach', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_after_send_remind_days', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_before_terms_remind_days', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_after_terms_remind_days', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_high_priority', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_paypal_address', 'sanitize_email' );
	register_setting( 'cqpim_settings', 'client_invoice_stripe_key', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_stripe_secret', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_stripe_ideal', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_deposit_invoice_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_deposit_invoice_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_invoice_reminder_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_reminder_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_invoice_overdue_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_overdue_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_invoice_footer', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_deposit_invoice_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_invoice_allow_partial', 'absint' );
	register_setting( 'cqpim_settings', 'client_invoice_twocheck_sid', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_receipt_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_invoice_receipt_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_escrow_email_address', 'sanitize_email' );
	register_setting( 'cqpim_settings', 'pto_escrow_api_key', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'pto_escrow_inspection', 'absint' );

	// Teams
	register_setting( 'cqpim_settings', 'team_account_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'team_account_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'team_reset_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'team_reset_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'team_project_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'team_project_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'team_assignment_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'team_assignment_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'assignment_response_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'assignment_response_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'pto_task_acceptance', 'absint' );
	register_setting( 'cqpim_settings', 'pto_task_status' );//allow arrays

	// Support
	register_setting( 'cqpim_settings', 'cqpim_disable_ticket_priority', 'absint' );
	register_setting( 'cqpim_settings', 'client_create_ticket_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'support_status' );//allow arrays

	// Email
	register_setting( 'cqpim_settings', 'client_create_ticket_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'client_update_ticket_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'client_update_ticket_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'company_update_ticket_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'company_update_ticket_email', 'wp_kses_post' );

	// FAQ
	register_setting( 'cqpim_settings', 'cqpim_enable_faq', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_enable_faq_dash_accordion', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_enable_faq_dash_cats', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_enable_faq_dash', 'absint' );

	// Quote Forms
	register_setting( 'cqpim_settings', 'cqpim_frontend_form', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_backend_form', 'absint' );
	register_setting( 'cqpim_settings', 'form_reg_auto_welcome', 'absint' );
	register_setting( 'cqpim_settings', 'form_auto_welcome', 'absint' );
	register_setting( 'cqpim_settings', 'pto_frontend_form_google_recaptcha', 'absint' );
	register_setting( 'cqpim_settings', 'new_quote_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'new_quote_email', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_dash_css', 'wp_strip_all_tags' );
	register_setting( 'cqpim_settings', 'cqpim_logout_url', 'esc_url_raw' );
	register_setting( 'cqpim_settings', 'gdpr_pp_page', 'absint' );
	register_setting( 'cqpim_settings', 'gdpr_pp_page_check', 'absint' );
	register_setting( 'cqpim_settings', 'gdpr_tc_page', 'absint' );
	register_setting( 'cqpim_settings', 'gdpr_tc_page_check', 'absint' );
	register_setting( 'cqpim_settings', 'gdpr_consent_text', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'gdpr_consent', 'absint' );
	register_setting( 'cqpim_settings', 'pto_cquo_approve', 'absint' );
	register_setting( 'cqpim_settings', 'pto_creg_approve', 'absint' );
	register_setting( 'cqpim_settings', 'google_recaptcha_site_key', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'google_recaptcha_secret_key', 'sanitize_text_field' );

	// Suppliers and Expenses
	register_setting( 'cqpim_settings', 'cqpim_activate_expense_auth', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_expense_auth_limit', 'floatval' );
	register_setting( 'cqpim_settings', 'cqpim_expense_auth_members', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_auth_email_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_auth_email_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_authorised_email_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_authorised_email_content', 'wp_kses_post' );

	// Bug Tracker
	register_setting( 'cqpim_settings', 'cqpim_bugs_auto', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_new_bug_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_new_bug_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_update_bug_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_update_bug_content', 'wp_kses_post' );

	// WooCommerce
	register_setting( 'cqpim_settings', 'cqpim_wc_new_project_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_wc_new_project_content', 'wp_kses_post' );

	// Piping Settings
	register_setting( 'cqpim_settings', 'cqpim_mail_server', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_piping_address', 'sanitize_email' );
	register_setting( 'cqpim_settings', 'cqpim_mailbox_name', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_mailbox_pass', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_string_prefix', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_create_support_on_email', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_send_piping_reject', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_piping_delete', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_bounce_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_bounce_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_create_support_on_unknown_email', 'absint' );

	// Messaging Settings
	register_setting( 'cqpim_settings', 'cqpim_new_message_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_new_message_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_messages_allow_client', 'absint' );

	// HTML Email
	register_setting( 'cqpim_settings', 'cqpim_html_email_styles', 'wp_strip_all_tags' );
	register_setting( 'cqpim_settings', 'cqpim_html_email', 'wp_kses_post' ); //sanizitize html

	// Subscriptions
	register_setting( 'cqpim_settings', 'cqpim_new_subscription_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_new_subscription_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_new_subscription_accept_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_new_subscription_accept_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_cancelled_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_cancelled_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_failed_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_failed_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_reminder_subject', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_subscription_reminder_content', 'wp_kses_post' );
	register_setting( 'cqpim_settings', 'cqpim_paypal_api_signature', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_paypal_api_password', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_paypal_api_username', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_paypal_enable_sandbox', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_2checkout_enable_sandbox', 'absint' );
	register_setting( 'cqpim_settings', 'cqpim_twocheck_pub_key', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_twocheck_priv_key', 'sanitize_text_field' );
	register_setting( 'cqpim_settings', 'cqpim_twocheck_account', 'sanitize_text_field' );
}
			...
			<div id="main-container" class="cqpim_block">
				...
				<div id="tabs" style="display: none;">
					...
					<div id="tabs-1">
						...
						if ( $logo ) { ?>
							<img style="max-width:300px;background:#ececec" src="<?php echo esc_url( $logo['company_logo'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" /><br />
					...
					<div id="tabs-9">
						...
						<h3><?php esc_html_e('Dashboard Logo', 'projectopia-core'); ?></h3>
							<?php 
							$logo = get_option('cqpim_dash_logo'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage
							if ( $logo ) { ?>
								<img style="max-width: 300px;background: #ececec;" src="<?php echo esc_url( $logo['cqpim_dash_logo'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
								<br />
						...
						if ( $logo ) { ?>
							<img style="max-width: 300px;background: #ececec;" src="<?php echo esc_url( $logo['cqpim_dash_bg'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
							<br />
					...
					<div id="tabs-5">
						...
						if ( $logo ) { ?>
							<img style="max-width: 300px;background: #ececec;" src="<?php echo esc_url( $logo['cqpim_invoice_logo'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" />
							<br />
					...
					<div id="tabs-10">
						...
						<div class="task-status">
							...
							// PHP 8 strict array check fix
							if ( ! is_array( $pto_task_status ) ) {
								$pto_task_status = [];
							}
					...
					<div id="tabs-7">
						<?php if ( pto_has_addon_active_license( 'pto_st', 'tickets' ) ) { ?>
							...
							<div class="support-ticket-status">
	                            ...
	                            // PHP 8 strict array check fix
							    if ( ! is_array( $support_ticket_status ) ) {
