    ...
    <div class="pto-modal-wrapper">
		<form method="post" id="initial-settings-form" class="initial-settings-popup">
			<figure class="pto-logo-container mt-3">
				<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/img/pto-logo.png' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="projectopia" class="pto-logo"/>
			</figure>
			<div id="wizard">
				<!-- SECTION 1 -->
			   	<h4></h4>
