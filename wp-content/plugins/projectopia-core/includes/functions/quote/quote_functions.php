...
function pto_update_client_contacts() {
	...
	/* translators: %s: Client contact name */
...
function pto_process_quote_emails() {
	...
	$quote_url = add_query_arg('pto-page', 'quote', get_the_permalink($quote_id));
	$email_content = str_replace('%%QUOTE_CLIENT_URL%%', $quote_url, $email_content);
