    ...
    <div class="container-fluid">
        <nav class="navbar d-flex flex-row flex-nowrap justify-content-between align-items-center">
            ...
            <a class="navbar-brand my-0 py-0" href="<?php echo esc_url( get_dashboard_url() ); ?>">
                <img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/wp.png' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid wp-logo" />
            </a>
            ...
            <a class="navbar-brand my-0 py-0" href="<?php echo esc_url( admin_url( 'admin.php?page=pto-dashboard' ) ); ?>">
                <img src="<?php echo esc_url( $logo_url ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid projectopia-logo" />
            </a>
                    ...
                    <li>
                        ...
                        <div class="dropdown">
                            <a class="btn btn-notify" style="line-height: 1.8"
                                ...
                                <img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/massageicon.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid" />
                                <?php
                                    if ( ! empty( $unread_qty ) ) {
                    ...
                    <li>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-notify pto-noti-count" type="button" data-toggle="dropdown"
                                ...
                                <img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/notification.png' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid" />
                                <?php
                        ...
                        <li>
                            ...
                            <div class="dropdown">
                                <button class="btn btn-notify" type="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/settingicon.png' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid" />
                                </button>
