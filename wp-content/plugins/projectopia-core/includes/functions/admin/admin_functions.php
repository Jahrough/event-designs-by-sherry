...
function pto_overlay_template() {
	...
	printf('<div style="display:none" id="cqpim_overlay"><div id="cqpim_spinner"><img src="%s" /></div></div>', esc_url(PTO_PLUGIN_URL . '/img/loading_spinner.gif'));
						...
						<div class="col-xl-8 col-lg-7">
							<div class="pto-notification-alert__content-info">
								<div class="pto-notification-alert__image">
									<img src="<?php echo esc_url( PTO_PLUGIN_URL . '/assets/admin/img/alerticon.svg' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" class="img-fluid" />
								</div>
...
function pto_remove_logo() {
    // Verify the user has the required capability. By default administrator and cqpim_admin have this capability
    if ( ! current_user_can( 'edit_cqpim_settings' ) ) {
